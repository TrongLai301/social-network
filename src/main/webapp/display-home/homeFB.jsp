...
<div class="form-post" id="post">
    <div class="editFormDiv" id="divPostForm">
        <form class="editForm" id="postForm">
            ...
            <div>
                <input type="file" accept="image/*,video/*" id="media" value="">
            </div>
            <div>
                <img src="">
            </div>
...
<%--        logo user--%>
        ...
        <div class="user-settings">
            ...
            <div class="settings-links">
                ...
                <a href="/user?actionGet=showEditPassword">Settings your password <img src="../images/arrow.png" alt=""></a>
            </div>
            ...
            <div class="settings-links">
                ...
                <a href="/user?actionGet=updateUserProfile">Display & Edit your profile <img src="../images/arrow.png" alt=""></a>
            </div>

            <div class="settings-links">
                <img src="../images/logout.png" alt="" class="settings-icon">
                <a href="/session">Logout <img src="../images/arrow.png" alt=""></a>
            </div>
