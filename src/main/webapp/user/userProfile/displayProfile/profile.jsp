...
<div class="divFather">
    ...
    <div style="width: 100% ; height: 160px;background-color: #ffffff;display: inline-flex;justify-content: space-between;border-radius: 15px">
        ...
        <c:if test="${friend != null}">
        <div style=" float: left;   display: inline-flex; justify-content: space-between;align-items: center; padding-bottom: 100px;  padding-left: 30px;">
            <div><img src="<c:out value="${friend.getAvatar()}"/>"
                      style="border: 1px solid; border-radius: 50%;  height: 150px;width: 150px"></div>
            <div><p style="padding-left: 20px; font-size: 1.7em;padding-top: 10px;font-weight: 500;"><c:out
                    value="${friend.getName()}"/><br>
            </div>
            </c:if>
    ...
    height: 30px;text-decoration: none;color: black"><a
        ...
        <div class="container" style="justify-content: space-evenly;display: flex">
            ...
            <div style="float: left; height: 100%;width: 480px;">
                ...
                <br>
                <div class="displayAllPicture">
                    <p>
                    <h3>Picture library</h3></p>
                    <br>
                    <div class="pictureDiv">
                        <c:forEach var="media" items="${requestScope.listStatus}" end="3">
                            <div class="pictureElement"><img src="${media.media}"></div>
                        </c:forEach>
                    </div>
                ...
                <div class="friend-profile">
                    <div class="header-frs">
                        ...
                        <c:if test="${friend1 != 0}">
                            <a href="/user?actionGet=showListFriendsUser&idFriend=${idFriend1}&id=${requestScope.user.id}">View
                                all friend</a>
                        </c:if>
                    </div>
                    <div>
                    ...
                    <div class="status-field-container write-post-container">
                        ...
                        <div class="post-reaction">
                            <div class="activity-icons">
                                ...
                                <div style="padding-left: 40px"><img src="../../../display-home/images/comments.png"
                                                                     alt="">0
                                </div>
